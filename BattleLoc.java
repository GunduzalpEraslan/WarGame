...
public abstract class  BattleLoc  extends Location {
    ...
    public boolean onLocation() {
        ...
        System.out.println("Dikkatli ol !! Burada " + obsNumber + " tane " + this.getObstacle().getName() + " karşına çıkabilir!");
        System.out.println("<S>savaş veya <K>aç");
        System.out.println("Hızlı karar vermelisin!!");
